...
class ActivityController extends Controller
{
    ...
    public function index()
    {
        ...
        $extension = ActivityModel::where('activity_parent', 'extension')->orderBy('id', 'desc')->get();
        // dd('test');

        return view('admin.activities.index', compact('expedition', 'trekking', 'activity', 'travels', 'extension'));
    }
