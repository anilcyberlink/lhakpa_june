...
class TripController extends Controller
{
    ...
    public function create()
    {
        ...
        $availability = array( 'AVAILABLE' => 'AVAILABLE', 'GUARANTEED' => 'GUARANTEED', 'LIMITED'=>'LIMITED' ,'CLOSED' => 'CLOSED');
        $ordering += 1;
        ...
        if ($request->ajax()) {
            ...
            if (isset($request->schedule_ordering)) {
                ...
                foreach ($schedule_keys as $key) {
                    ...
                    $tripSchedule->old_price1 = $request->schedule_old_price1[$key];
                    $tripSchedule->old_price2 = $request->schedule_old_price2[$key];
            ...
            if (isset($request->faq_ordering)) {
              ...
              $sn_itinerary_count = count($request->itinerary_ordering);
                foreach($keys as $key){
                  ...
                  $tripItinerary->transport = $request->itinerary_transport[$key];
            ...
            if (isset($request->schedule_ordering)) {
                ...
                foreach ($schedule_keys as $key => $value) {
                    ...
                    if ($request->schedule_id[$value] == "") {
                        ...
                        $scheduleData->old_price1 = $request->schedule_old_price1[$key];
                        $scheduleData->old_price2 = $request->schedule_old_price2[$key];
            ...
            if (isset($request->itinerary_ordering)) {
                ...
                foreach ($keys as $key => $value) {
                    ...
                    if ($request->itinerary_id[$value] == "") {
                        ...
                        $itineraryData->transport = $request->itinerary_transport[$key];
