            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="col-lg-12">
                            <div class="bs-component">
                                <input type="text" class="form-control" name="category_video"
                                    value="{{ $data->category_video }}" placeholder="Unique Video ID of youtube video" />
                    ...
                    <label class="field select">
                        <select name="activity_parent">
                            <option value="expedition" {{ $data->activity_parent == 'expedition' ? 'selected' : '' }}>
                                Expedition</option>
                            <option value="trekking" {{ $data->activity_parent == 'trekking' ? 'selected' : '' }}>
                                Destination</option>
                            <option value="activity" {{ $data->activity_parent == 'activity' ? 'selected' : '' }}>Activity
                            </option>
                            <option value="travel" {{ $data->activity_parent == 'travel' ? 'selected' : '' }}>Travels
                            </option>
                            <option value="extension" {{ $data->activity_parent == 'extension' ? 'selected' : '' }}>Extension Packages
                            </option>
                        </select>
                        <i class="arrow"></i>
                    </label>
