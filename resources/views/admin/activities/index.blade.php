        ...
        <div class="">
            ...
            <div class="panel-heading">
                <ul class="nav panel-tabs-border panel-tabs panel-tabs-left">
                    ...
                    <li>
                        <a href="#tab1_5" data-toggle="tab">Extensions</a>
                    </li>
                </ul>
            </div>
            <div class="panel-body">
                <div class="tab-content pn br-n">
                                                    ...
                                                    @foreach ($expedition as $row)
                                                        <tr class="id{{ $row->id }}">
                                                            ...
                                                            <td class="">
                                                                ...
                                                                <div class=""><span class="id">ID:
                                                                        {{ $row->id }} | </span><span class="edit"><a
                    ...
                    <td><a href="{{route('activity.banner.index',$row->id)}}" title="Manage Banner"><i class="fa fa-file-image-o fa fa-2x" aria-hidden="true"></i></a></td>*/
                                                            ...
                                                            <td>
                                                                @if ($row->thumbnail)
                                                                    <img src="{{ url(env('PUBLIC_PATH') . 'uploads/icon/' . $row->thumbnail) }}"
                                                                        width="100" />
                                                                @endif
                                                            </td>
                                                        ...
                                                        <tr class="id{{ $row->id }}">
                                                            ...
                                                            <td class="">
                                                                ...
                                                                <div class="">
                                                                    ...
                                                                    <span class="edit">
                                                                        <a href="{{ url('admin/' . Request::segment(2) . '/' . $row->id . '/edit') }}"
                                                                            aria-label="">Edit</a>
                                                                    </span> |
                                                                    <span class="trash"><a href="#{{ $row->id }}"
                                                                            class="submitdelete1">Delete</a> </span>
