        ...
        <div class="col-md-12">
            ...
            <div class="panel">
             ...
             <div class="form-group">
                ...
                @if(Request::segment(3) == 'international-team')
                <div class="form-group">
                    <label for="inputStandard" class="col-lg-2 control-label">Languages</label>
                    <div class="col-lg-9">
                        <div class="bs-component">
                            <div class="bs-component">
                                <input class="form-control" name="language" rows="3" autocomplete="off" value="{{ $data->language }}"/>
                            </div>
                        </div>
                    </div>
                </div>
                  ...
                  <label for="title" class="col-lg-2 control-label">Show in detail</label>
                    <div class="col-lg-9">
                        ...
                        <input type="checkbox" name="in_detail"
                               value="{{ $data->in_detail }}" {{ ($data->in_detail == 1)?'checked':'' }} />
                        </div>
                    </div>
                </div>
                @endif
