            ...
            <div class="navbar-branding">
                <a class="navbar-brand" href="{{ url('/') }}" target="_blank">
                    <div class="uk-width-auto@m">
                        <img src="{{asset('theme-assets/img/green-lhakpa.png')}}" width="180" alt="{{ config('app.name') }}">
                    </div>
        ...
        <aside id="sidebar_left" class="nano nano-primary affix">
            ...
            <div class="sidebar-left-content nano-content">
                ...
                <li class="{{ (Request::segment(2) == 'region'||Request::segment(2) == 'trip-region')?'active':'' }}">
                    ...
                    ?>
                    <li class="">
                        @if(Request::segment(1) == 'newsletter-create' || Request::segment(2) == 'viewUser' || Request::segment(1) == 'subscriber-create'|| Request::segment(1) == 'send-newsletter'|| Request::segment(1) == 'subscriber-index'|| Request::segment(1) == 'subscriber-edit'|| Request::segment(1) == 'newsletter-index'|| Request::segment(1) == 'newsletter-edit')
                            <a class="accordion-toggle menu-open">
                        @else
                            <a class="accordion-toggle">
                        @endif
                        ...
                        <ul class="nav sub-nav">
                            ...
                            <li class="{{ (Request::segment(1) == 'subscriber-create'|| Request::segment(2) == 'viewUser' || Request::segment(1) == 'subscriber-index'|| Request::segment(1) == 'subscriber-edit')?'active':'' }}">
                   ...
                   */
                    ...
                    <li class="{{ Request::segment(2) == 'feedbacks' ? 'active' : '' }}">
                        <a href="{{ route('admin.feedbacks') }}">
                            ...
                            <span class="sidebar-title"> Feedbacks </span>
                        </a>
                    </li>
