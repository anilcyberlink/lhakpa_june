                                ...
                                @foreach ($data as $row)
                                    <tr class="id{{ $row->id }}">
                                        ...
                                        <td>
                                            ...
                                            @if(has_associatedpost($row->id) > 0 || Request::segment(2) == 'mesage-from-us'|| Request::segment(2) == 'about-company' || Request::segment(2) == 'international-team' || (Request::segment(2) == 'suggestion' && $row->id != '195') )
                                                <a href="{{ url('admin/associated/' . Request::segment(2) . '/' . $row->id) }}"><i
                                                    class="fa fa-plus fa fa-2x"></i></a>
                                            @endif
                                            {{-- @endif --}}

                                            @if (has_postimage($row->id) > 0 || Request::segment(2) == 'why-us' || Request::segment(2) == 'official-documents' || (Request::segment(2) == 'suggestion' && $row->id == '195') || Request::segment(2) == 'mingmar-foundation' || Request::segment(2) == 'news-blogs' || Request::segment(2) == 'associate-and-partners')
