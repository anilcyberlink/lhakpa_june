                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                ...
                                <textarea type="text" class="form-control my-editor" id="contentEditor4" name="text3_sub_title" placeholder="sub_title" value="{{$data->text3_sub_title}}">{{$data->text3_sub_title}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
