...
@section('content')
    <form class="form-horizontal" role="form" action="{{ url('admin/trips-tag/' . $tripsTag->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="col-md-9">
            ...
            <div class="panel">
                <div class="panel-heading">
                    <span class="panel-title"> Edit Trip Tag </span>
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        <label for="title" class="col-lg-2 control-label">Tag Name</label>
                        <div class="col-lg-9">
                            <div class="bs-component">
                                <input type="text" id="title" name="title" class="form-control" placeholder="Tag Name" value="{{ old('title', $tripsTag->title) }}" required />
