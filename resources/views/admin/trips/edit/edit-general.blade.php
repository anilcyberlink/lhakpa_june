                    ...
                    <div class="bs-component">
                        <label>Flight Included?</label>
                         <select class="form-control" name="flight">
                            <option @if($data->flight==1)selected @endif value="1">Yes</option>
                            <option @if($data->flight==0)selected @endif value="0">No</option>
                        </select>
                    </div>
                </div>
                 <div class="col-lg-6">
                    ...
                    @if ( $activity->count() > 0)
                        <ul class="">
                            @foreach ($activity as $row)
                                <li>
                                    <label class="option">
                                        <input type="checkbox" class="single-check" name="activity_type[]" value="{{ $row->id }}" 
                                            {{ in_array($row->id, $checked_activities) ? 'checked' : '' }} >
                                        <span class="checkbox"></span> {{ $row->title }}
                                    </label>
                                </li>
