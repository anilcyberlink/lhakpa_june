            ...
            <div class="uk-visible@l uk-container uk-white " style="position:relative;z-index:1000;">
                <div class=" uk-flex uk-flex-middle uk-grid-collapse uk-grid uk-margin-top uk-top-nav">
                    ...
                    <div class="uk-width-auto@m uk-flex">
                        <a href="{{ url('/') }}"> <img src="{{asset('theme-assets/img/white-lhakpa.png')}}" width="200"
                                alt=""></a>
                        ...
                        <!--</h2>-->
                        <img src="{{asset('theme-assets/img/Final-Change-white.gif')}}" alt=""
                    ...
                    <div class="uk-width-expand@m">
                        <ul class="uk-flex uk-flex-right uk-topnavbar-ul uk-margin-bottom">
                            @if($news)
                                <li class="border-right"><a
                                        href="{{route('page.posttype_detail', $news->uri)}}">{{ $news->post_type }}</a></li>
                            @endif
                            @if($women)
                                <li class="border-right"><a
                                        href="{{route('page.posttype_detail', $women->uri)}}">{{ $women->post_type }}</a>
                                </li>
                            @endif
                            @if($tourism)
                                <li class="border-right"><a
                                        href="{{route('page.posttype_detail', $tourism->uri)}}">{{ $tourism->post_type }}</a>
                                </li>
                            @endif
                        </ul>
                        <ul class="uk-flex uk-flex-right uk-topnavbar-ul">
                            ...
                            <li class="uk-margin-small-left">
                                @if($plan_trip)
                                    <a href="{{route('page.posttype_detail', $plan_trip->uri)}}"
                                        class="inquiry-btn">{{ $plan_trip->post_type }}</a>
                                @endif
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="uk-container">
                        <nav class="uk-navbar d-flex uk-flex-middle" uk-navbar="dropbar: true; uk-dropbar-top">
                            <div class="uk-navbar-left">
                                <a href="{{ url('/') }}" class="uk-logo-dark">
                                    <img src="{{asset('theme-assets/img/green-lhakpa.png')}}" width="180" alt="">
                                </a>
                            </div>
                            <div class="uk-navbar-right">
                                <ul class="uk-navbar-nav uk-position-relative">
                                                ...
                                                <div uk-grid class="uk-grid-small">
                                                    ...
                                                    <div id="company-switcher" class="uk-switcher uk-width-expand@m">
                                                        ...
                                                        <div>
                                                            <ul class="uk-list uk-highlight uk-navbar-list">
                                                                @foreach ($navigations->where('nav_type', 'company') as $nav)
                                                                    <li>
                                                        ...
                                                        <div>
                                                            <ul class="uk-list uk-highlight uk-navbar-list">
                                                                @foreach ($navigations->where('nav_type', 'support') as $nav)
                                                                    <li>
                                                                        <a href="{{ route('page.posttype_detail', $nav->uri) }}">
                                                                            {{ $nav->post_type }}
                                                                        </a>
                                                        ...
                                                        <div>
                                                            <ul class="uk-list uk-highlight uk-navbar-list">
                                                                @foreach ($navigations->where('nav_type', 'media') as $nav)
                                                                    <li>
                                                                        <a href="{{ route('page.posttype_detail', $nav->uri) }}">
                                                                            {{ $nav->post_type }}
                                                                        </a>
                                                    ...
                                                    <div class="uk-width-expand uk-padding-remove">
                                                        ...
                                                        <div class="uk-child-width-1-2@m uk-grid-small" uk-grid>
                                                            ...
                                                            @foreach ($navigations->take(2) as $nav)
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div class="uk-media-280 uk-activities uk-position-relative uk-display-block">
                                                                        ...
                                                                        <a href="{{ route('page.posttype_detail', $nav->uri) }}"
                                                                            ...
                                                                            <img src="{{ $nav->banner ? asset('uploads/original/' . $nav->banner) : asset('theme-assets/img/mountain/mountain1.jpeg') }}"
                                                ...
                                                <div uk-grid class="uk-grid-small">
                                                    ...
                                                    <ul class="tab-nav uk-mega-tab uk-padding-menu uk-tab-left uk-margin-medium-right border-0"
                                                        ...
                                                        @foreach ($trekking as $trek)
                                                            <li>
                                                                <a href="#">{{ strtoupper($trek->title) }}</a>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                    {{-- RIGHT CONTENT --}}
                                                            ...
                                                            @foreach ($activity as $key => $value)
                                                                <div class="uk-position-relative uk-visible-toggle uk-light"
                                                                            ...
                                                                            <div>
                                                                                <a
                                                                                    ...
                                                                                    <div class="uk-list-shine uk-media-205 uk-border-rounded uk-cover-container  uk-display-block uk-transition-toggle uk-link-toggle "
                                                                                        ...
                                                                                        <img class="uk-image uk-cover uk-transition-scale-up uk-transition-opaque uk-effect-1"
                                                                                            alt=""
                                                                                            src="{{ $item['thumbnail'] ? asset('uploads/original/' . $item['thumbnail']) : asset('theme-assets/img/mountain/mountain1.jpeg')}} " />
                                                                                        <div
                                                                                            class="uk-overlay-banner  uk-position-cover uk-heading-overlay">
                                                                                        </div>
                                                                                        <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <a href="{{ route('activity-list', $value->uri) }}"
                                                            ...
                                                            <a href="{{ route('travel-list', $travel->uri) }}">
                                                                <div class="uk-list-shine uk-media-140 uk-cover-container border  uk-display-block uk-transition-toggle uk-link-toggle"
                                                                    ...
                                                                    <img class="uk-image uk-cover uk-transition-scale-up uk-transition-opaque"
                                                                        alt="{{ $travel->title }}"
                                                                        src="{{ $travel->thumbnail ? asset('uploads/icon/' . $travel->thumbnail) : asset('theme-assets/img/mountain/mountain3.jpeg') }}" />
                                                                    <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <h2 class="uk-secondary mb-18">{{ $travel->title }}
                                                                        </h2>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div>
                                                            <a href="{{route('page.posttype_detail', $your_group->uri)}}">
                                                                <div class="uk-list-shine uk-media-140 uk-cover-container border  uk-display-block uk-transition-toggle uk-link-toggle"
                                                                    href="detail.php">
                                                                    <img class="uk-image uk-cover uk-transition-scale-up uk-transition-opaque"
                                                                        alt="{{ $your_group->post_type }}"
                                                                        src="{{ $your_group->banner ? asset('uploads/original/' . $your_group->banner) : asset('theme-assets/img/mountain/mountain8.jpeg')}}" />
                                                                    <div
                                                                        class="uk-overlay-banner uk-heading-overlay uk-position-cover">
                                                                    </div>
                                                                    <div
                                                                    ...
                                                                    <div class="uk-child-width-1-2@m uk-grid">
                                                                        <div>
                                                                            <div class="uk-title-fonts">
                                                                                <h2 class="uk-secondary">{{$value->title}}
                                                                                </h2>
                                                                        ...
                                                                        <div>
                                                                            <div
                                                                                ...
                                                                                <div>
                                                                                    <img src="{{!empty($value->thumbnail) ? asset('uploads/icon/' . $value->thumbnail) : asset('theme-assets/img/mountain/mountain3.jpeg')}}"
                                                                                        alt="" class="border uk-media-140">
                                                                                </div>
                                                                                <div>
                                                                                    <img src="{{!empty($value->banner) ? asset('uploads/banners/' . $value->banner) : asset('theme-assets/img/mountain/mountain4.jpeg')}}"
                                                                                        alt="" class="border uk-media-140">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        @foreach ($tripChunks as $chunk)
                                                                            <ul class="uk-list uk-highlight uk-navbar-list">
                                                                                @foreach ($chunk as $item)
                                                                                    <li> <a
                                                                                            href="{{ url('page/' . tripurl($item['uri'])) }}">{{ $item['trip_title'] }}</a>
                                                                                @endforeach
                                                                            </ul>
                                                                        @endforeach
                                                                    </div>
                                    ...
                                    <li class="uk-flex uk-flex-middle">
                                        <form class="uk-search uk-search-default" action="{{ route('searchtrip') }}"
                                            method="GET">
                            ...
                            <nav class="uk-navbar" uk-navbar="{&quot;container&quot;:&quot;.uk-header-mobile&quot;}">
                                <div class="uk-navbar-left">
                                    <a href="{{ url('/') }}" class="uk-logo uk-navbar-item"> <img
                                            src="{{asset('theme-assets/img/green-lhakpa.png')}}" alt=""
                                            style="height:65px;"> </a>
                                </div>
                                <div class="uk-navbar-right" style="gap: 10px;">
                                    ...
                                    @if(Auth::check())
                                        <a href="{{ route('user-wishlist') }}">
                                            <i
                                                class="fa-solid fa-heart uk-white f-20 uk-margin-small-right"></i>[{{ Auth::user()->wishlists->count()}}]
                                        </a>
                                    @else
                                        <a href="{{ route('user-wishlist') }}">
                                    ...
                                    <div id="modal-search" uk-modal>
                                        <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
                                            <form class="uk-search uk-search-default uk-width-1-1"
                                                action="{{ route('searchtrip') }}" method="GET">
                                        ...
                                        <div class="uk-panel" id="module-menu-dialog-mobile">
                                            <ul class="uk-nav uk-nav-primary  uk-nav-divider uk-nav-accordion uk-margin-top"
                                                ...
                                                <li class="js-accordion uk-parent">
                                                    ...
                                                    <ul class="uk-nav-sub two-column-nav">
                                                        @foreach ($navigations as $nav)
                                                            <li><a href="{{route('page.posttype_detail', $nav->uri)}}"
                                                                    style="padding: 10px 6px;">{{$nav->post_type}}</a></li>
                                                        @endforeach
                                                    </ul>
                                                </li>
                                                <li class="js-accordion uk-parent">
                                                    ...
                                                    <ul class="uk-nav-sub">
                                                        @foreach ($trekking as $trek)
                                                            <li><a href="{{ route('trekking-list', $trek->uri) }}"><span
                                                                        uk-icon="icon:   arrow-right"></span>{{$trek->title}}</a>
                                                            </li>
                                                        @endforeach
                                                ...
                                                <li class="js-accordion uk-parent">
                                                    ...
                                                    <ul class="uk-nav-sub">
                                                        @foreach ($expedition as $row)
                                                            <li><a href="{{ route('expedition-list', $row->uri) }}"><span
                                                                        uk-icon="icon:   arrow-right"></span>{{ $row->title }}</a>
                                                            </li>
                                                        @endforeach
                                                        <li><a href="{{ route('page.expeditionlist') }}"> View All</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="js-accordion uk-parent">
                                                    ...
                                                    <ul class="uk-nav-sub">
                                                        @foreach ($activity as $row)
                                                            <li><a href="{{ route('trekking-list', $row->uri) }}"><span
                                                                        uk-icon="icon:   arrow-right"></span>{{ $row->title }}</a>
                                                            </li>
                                                        @endforeach
                                                ...
                                                <li class="js-accordion uk-parent">
                                                    ...
                                                    <ul class="uk-nav-sub">
                                                        @foreach ($travels as $travel)
                                                            <li><a href="{{ route('travel-list', $travel->uri) }}"><span
                                                                        uk-icon="icon:   arrow-right"></span>{{ $travel->title }}</a>
                                                            </li>
                                                        @endforeach
                                                        @if ($your_group)
                                                            <li><a
                                                                    href="{{route('page.posttype_detail', $your_group->uri)}}"><span
                                                                        uk-icon="icon:   arrow-right"></span>{{ $your_group->post_type }}</a>
                                                            </li>
                                                        @endif
                                                    </ul>
                                                </li>
                                                <li><a
                                                        href="{{route('page.posttype_detail', $news->uri)}}">{{ $news->post_type }}</a>
                                                </li>
                                                <li class="js-accordion uk-parent">
                                                    ...
                                                    <ul class="uk-nav-sub">
                                                        <li><a href="{{route('page.posttype_detail', $women->uri)}}"><span
                                                                    uk-icon="icon:   arrow-right"></span>{{ $women->post_type }}</a>
                                                        </li>
                                                        <li> <a href="{{route('page.posttype_detail', $tourism->uri)}}"><span
                                                                    uk-icon="icon:   arrow-right"></span>{{ $tourism->post_type }}</a>
                                                        </li>
                                                        <li> <a
                                                                href="{{route('page.posttype_detail', $suggestion->uri)}}"><span
                                                                    uk-icon="icon:   arrow-right"></span>{{ $suggestion->post_type }}</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li><a href="{{ route('page.posttype_detail', $contact_us->uri) }}">Contact
                                                        Us</a></li>
                                                @if($plan_trip)
                                            ...
                                            <div class="uk-padding uk-padding-remove-top uk-text-center">
                                                ...
                                                <a href="{{ $setting->twitter_link }}" class="uk-icon-button"><i
