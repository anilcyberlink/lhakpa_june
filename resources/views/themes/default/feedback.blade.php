                ...
                <div class="form-body">
                    ...
                    <div class="rating-group">
                        ...
                        <div class="rating-options">
                            <input type="radio" name="accommodation" value="excellent" id="accommodation-excellent"
                                   {{ old('accommodation') == 'excellent' ? 'checked' : '' }} required>
                    ...
                    <div class="uk-margin-top">
                        ...
                        <textarea class="uk-textarea" rows="4" name="favourite"
                                  placeholder="Share your favorite moments from the trek..." required>{{ old('favourite') }}</textarea>
                    </div>

                    <div class="uk-margin-top">
                        <label>What could we improve?</label>
                        <textarea class="uk-textarea" rows="4" name="improvement" required>{{ old('improvement') }}</textarea>
                    </div>
                    ...
                    <div class="uk-margin">
                        ...
                        <textarea class="uk-textarea" name="guide_professionalism" rows="2" required>{{ old('guide_professionalism') }}</textarea>
                    </div>

                    <div class="uk-margin">
                        <label>Did the guide share interesting local culture & nature information?</label>
                        <textarea class="uk-textarea" name="guide_knowledge" rows="2" required>{{ old('guide_knowledge') }}</textarea>
                    </div>

                    <div class="uk-margin">
                        <label>How was the support from porters & local staff?</label>
                        <textarea class="uk-textarea" name="porter_support" rows="2" required>{{ old('porter_support') }}</textarea>
                    </div>

                    <div class="uk-margin">
                        <label>Comments:</label>
                        <textarea class="uk-textarea" name="comments" rows="3" required>{{ old('comments') }}</textarea>
                    </div>
                    ...
                    <div class="uk-margin-top">
                        ...
                        <div class="checklist-group">
                            ...
                            <div class="checklist-item">
                                <input type="checkbox" name="guide_qualities[]" value="cultural" id="cultural"
                                       {{ in_array('cultural', old('guide_qualities', [])) ? 'checked' : '' }}>
                        ...
                        <div class="uk-margin-top">
                            <input class="uk-input" type="text" name="guide_qualities_other"
                                   value="{{ old('guide_qualities_other') }}"
                    ...
                    <div class="uk-margin-top">
                        ...
                        <div class="uk-margin-top">
                            <input class="uk-input" type="text" name="future_destinations_other"
                                   value="{{ old('future_destinations_other') }}"
