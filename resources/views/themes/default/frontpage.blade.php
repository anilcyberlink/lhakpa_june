...
@section('content')
                ...
                @if ($banner->youtube_link)
                    <div class="swiper-slide">
                        <div class="uk-position-relative" id="ytbg3" data-ytbg-fade-in="true" data-ytbg-mute-button="true"
                            data-youtube="https://youtu.be/{{ $banner->youtube_link }}"></div>
                ...
                @else
                    ...
                    <div class="swiper-slide">
                        <div class="uk-inline hero-items">
                            <img src="{{ $banner->picture ? asset('uploads/banners/' . $banner->picture) : asset('theme-assets/img/mountain/mountain5.jpeg') }}"
            ...
            <div class="uk-grid-match uk-flex uk-flex-middle" uk-grid>
                <div class="uk-width-1-3@m">
                    <div class="uk-title-font">
                        ...
                        <a href="{{ route('page.activitylist') }}" class="uk-btn uk-btn-secondary">Discover All
                            Activities</a>
                    </div>
                </div>
                            ...
                            @foreach ($activity_list as $row)
                                <div class="uk-media-400 uk-activities">
                                    @if ($row->external_link)
                                        ...
                                        @else
                                            <a href="{{ route('activity-list', $row->uri) }}"
                                                class="uk-list-shine uk-display-block uk-inline-clip uk-transition-toggle uk-link-toggle uk-height-1-1">
                                    @endif
                                    <img src="{{ $row->thumbnail ? asset('uploads/icon/' . $row->thumbnail) : asset('theme-assets/img/mountain/mountain1.jpeg') }} "
                                        class="uk-height-1-1 uk-transition-scale-up uk-transition-opaque" width="1800"
                                        height="1200" alt="{{ $row->title }}">
        ...
        <section class="uk-primary-bg ">
            <div class=" uk-grid-match uk-grid-collapse uk-primary-bg  uk-about-text" uk-grid>
                <div class=" uk-width-3-4@m  uk-padding uk-padding-left uk-index-responsive-padding">
                    <div class="uk-container uk-flex uk-flex-middle uk-margin-top uk-margin-bottom">
                        <div class="uk-title-font uk-contents">
                            ...
                            {!! $about_us->content !!}
                            <!-- </span> -->
                            <a href="{{ route('page.posttype_detail', $about_us->uri) }}" class="uk-about-btn">Learn More
                ...
                <div class="uk-width-1-4@m uk-padding uk-flex uk-flex-center uk-flex-middle ">
                    <img src="{{ asset('theme-assets/img/logo.gif') }}" class="about-img"
                        alt="{{ $about_us->post_type }}">
                </div>
            </div>
        </section>
    @endif
                                    ...
                                    <div class="uk-flex uk-flex-middle uk-trip ">
                                        ...
                                        <div>
                                            ...
                                            <p class="uk-trip-description uk-margin-remove">
                                                {{ optional($row->destinations()->first())->title }}</p>
                                        </div>
                                    </div>
                                    <div class="uk-flex uk-flex-middle uk-trip ">
                                        <i class="fa-solid fa-calendar"></i>
    ...
    uk-background-cover" uk-parallax="bgx: -100; easing: 1;" data-src="{{ asset('theme-assets/img/bg/01.jpg') }}" uk-img>
                        ...
                        @foreach ($lastMomentTrip as $row)
                            <li>
                                <a href="{{ url('page/' . tripurl($row->uri)) }}"
                                    ...
                                    <img src="{{ !empty($row->banner) ? asset('uploads/banners/' . $row->banner) : asset('theme-assets/img/mountain/mountain5.jpeg') }}"
                                                ...
                                                <div class="uk-grid-expand uk-margin-remove-top" uk-grid>
                                                    <div class="uk-flex uk-flex-middle">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="uk-small-description uk-margin-remove uk-white">{{ $row->duration }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="uk-flex uk-flex-middle">
                                                    ...
                                                    <div class="uk-flex uk-flex-middle uk-margin-remove">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="uk-small-description uk-margin-remove uk-white">{{ $row->trip_grade }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    @foreach ($trekking as $trek)
                        <div class="uk-media-500 uk-activities" style="overflow:hidden;">
                            <a href="{{ route('trekking-list', $trek->uri) }}"
                                ...
                                <img src="{{ !empty($trek->thumbnail) ? asset('uploads/icon/' . $trek->thumbnail) : asset('theme-assets/img/mountain/mountain3.jpeg') }}"
                                    class="uk-height-1-1 uk-transition-scale-up uk-transition-opaque" width="1800"
                                    height="1200" alt="">
                                <div class="uk-overlay-primary  uk-banner-overlay uk-position-cover"></div>
                                ...
                                <div class="uk-overlay uk-position-center uk-light uk-text-center uk-title-font ml-20">
                                    ...
                                    <!--</div>-->
                                    <div>
                                        <a href="{{ route('trekking-list', $trek->uri) }}" class="uk-about-btn">Learn
                                            More
                                            <i class="fa-solid fa-circle-arrow-right uk-margin-small-left"></i></a>
                                    </div>
                                </div>
    ...
    <section class="uk-section uk-padding-remove-top">
        <div class="uk-container">
            <div class="uk-grid">
                ...
                <div class="uk-width-1-4@s uk-flex uk-flex-right  uk-flex-middle uk-visible@s">
                    <a href="{{ route('page.posttype_detail', $blog->uri) }}" class="uk-btn uk-btn-secondary">View
                        All</a>
                </div>
            </div>
            <div class="uk-position-relative uk-visible-toggle uk-light uk-margin-top" tabindex="-1"
                    ...
                    @foreach ($blogs as $row)
                        <div>
                            <a href="{{ route('page.pagedetail', $row->uri) }}"
                                ...
                                <img src="{{ !empty($row->page_thumbnail) ? asset('uploads/original/' . $row->page_thumbnail) : asset('theme-assets/img/mountain/mountain5.jpeg') }} "
                            ...
                            <div class="uk-flex uk-flex-between uk-flex-middle">
                                <div class="uk-text-title uk-margin-top">
                                    <span class="uk-primary"><i class="fa-solid fa-calendar uk-margin-small-right"></i>
                                        {{ date('l F j, Y', strtotime($row->post_date)) }}</span>
    ...
    <section class="uk-primary-bg">
        <div class="uk-child-width-1-2@m uk-grid-match uk-grid-collapse" uk-grid>
            <div>
                <img src="{{ asset('theme-assets/img/review.jpeg') }}" alt=""
                                    ...
                                    @foreach ($reviews as $value)
                                        <div class="uk-width-1-1">
                                            ...
                                            <div class="uk-flex uk-margin-top">
                                                <img src="{{ $value->image ? asset('uploads/reviews/' . $value->image) : asset('theme-assets/img/user.png') }}"
                                                ...
                                                <div class="uk-title-font">
                                                    ...
                                                    @if (trip_count($value->user_id) >= 1)
                                                        <p class="uk-white uk-margin-top">
                                                            {{ trip_count($value->user_id) }} trip with Lhakpa Treks</p>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
