...
@section('content')
    ...
    <section
        ...
        uk-height-viewport data-src="{{ asset('uploads/banners/' . $data->banner) }}" alt="{{ $data->trip_title }}" uk-img>
        <div class="uk-overlay-banner uk-position-cover"></div>
        <div class="uk-container uk-width-1-1 pt-detail-150 pb-23 uk-position-relative">
            <div class="uk-flex uk-flex-middle uk-grid-collapse uk-margin-top" uk-grid
                            ...
                            <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" uk-slider>
                                <div class="uk-slider-items uk-child-width-1-1 uk-child-width-1-2@m uk-grid"
                                    ...
                                    @foreach ($photos as $photo)
                                        <div>
                                            <a class="uk-inline uk-media-270 uk-width-1-1"
                                                href="{{ asset('/uploads/original/' . $photo->thumbnail) }}">
                                                <img src="{{ asset('/uploads/original/' . $photo->thumbnail) }}"
                                                    class="border" alt="{{ $photo->title }}">
                                            </a>
                                        </div>
                                    @endforeach
                                </div>
                                        ...
                                        @foreach ($photos as $row)
                                            <li>
                                                <div class="video-container">
                                                    @if ($row->video)
                                                        <iframe src="https://www.youtube.com/embed/{{ $row->video }}"
                    ...
                    <div class="uk-grey-bg  uk-padding-dicovery  uk-pattern-bg">
                        ...
                        <div class="uk-margin-remove uk-flex uk-flex-between">
                            <button id="changeBtn1" class="uk-buttons uk-text-center">
                                <span class="uk-secondary"><i
                                        class="fa-solid fa-photo-film f-20 uk-margin-small-bottom"></i><br> Photos</span>
                            </button>
                            @if ($photo_videos->isNotEmpty())
                                <button id="changeBtn2" class="uk-buttons uk-text-center">
                                    <span class="uk-secondary "><i
                                            class="fa-solid fa-video f-20 uk-margin-small-bottom"></i><br>Videos</span>
                                </button>
                            @endif
                            <a href="#review" uk-scroll class="uk-buttons uk-text-center">
                                <span class="uk-secondary "><i
                                        class="fa-solid fa-users f-20 uk-margin-small-bottom "></i><br>Reviews</span>
                            </a>
                        </div>
                    </div>
                ...
                <div class="border uk-light">
                    <div class="uk-small-details-nav">
                        <div class="uk-container uk-position-relative uk-flex uk-flex-middle">
                            <ul class="uk-width-2-3 uk-navbar-single uk-flex  uk-margin-remove-bottom sidenav"
                                style="gap: 60px;">
                                <li>
                            ...
                            <div class="uk-width-1-3 uk-flex uk-flex-right uk-visible@m" style="gap: 8px;">
                                @if ($schedules->count() > 0)
                                    <a href="#offcanvas-usage" class="uk-btn uk-btn-secondary" uk-toggle
                                        style="padding: 6px 14px; font-size: 13px;">
                                        Dates & Prices
                                    </a>
                                    <a href="#modal-customize" class="uk-btn uk-btn-secondary" uk-toggle
                                        style="padding: 6px 14px; font-size: 13px;">
                                        Customize Trip
                                    </a>
                                @endif
                ...
                <div class="uk-width-3-4@l ">
                    <div id="features">
                        ...
                        <div>
                            <div class="uk-grid uk-flex ">
                                ...
                                <div class="uk-width-1-2@s uk-text-right@m uk-text-left uk-margin-top uk-responsive-flex">
                                    ...
                                    <div>
                                        @if ($data->trip_pdf)
                                            <a href="{{ route('trip.download.pdf', $data->id) }}"
                                                class="uk-btn uk-btn-secondary download-pdf-btn  " download>
                                    ...
                                    @if ($data->trip_code)
                                        <div class="uk-margin-top">
                                            <p><b class="uk-text-uppercase uk-secondary">Ref No:
                                                </b>{{ $data->trip_code }}</p>
                                        </div>
                                    @endif
                                </div>
                        ...
                        @if (!empty($data->trip_excerpt))
                            <div class="uk-font">
                                <span class="uk-primary uk-text-uppercase f-27 "><i
                                        class="fa-solid fa-list uk-margin-small-right" aria-hidden="true"></i>Important
                                    notice</span>
                            ...
                            @if ($itinerary->count() > 0)
                                <div class="uk-flex uk-flex-middle uk-flex-between">
                                    <div class="uk-font uk-text-center">
                                        <span class="uk-primary uk-text-uppercase f-27 "><i
                                                class="fa-regular fa-calendar uk-margin-small-right"
                                                aria-hidden="true"></i>Itinerary</span>
                                    </div>
                                    <div>
                                ...
                                <div
                                    class=" uk-light-bg uk-padding border uk-margin-top uk-margin-bottom uk-responsive-padding">
                                                ...
                                                <div class="uk-accordion-title  uk-itinerary-title">
                                                    <div class="uk-grid-small uk-flex-middle uk-grid-collapse" uk-grid>
                                                        <div class="uk-width-auto uk-text-center uk-first-column">
                                                            <div class="uk-day-title uk-margin-small-right"> Day
                                                                {{ $item->days }} </div>
                                                        </div>
                                                        <div class="uk-width-expand">
                                                            <div class="uk-width-1-1">
                                                                <p class="uk-margin-remove theme-font-medium">
                                                                    {{ $item->title }} </p>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="uk-width-1-4@l ">
                    ...
                    <div>
                        <div class="uk-light-bg border uk-padding-small uk-margin-top uk-padding-remove-top">
                            <div class="uk-child-width-1-4@m uk-child-width-1-2@l uk-child-width-1-3 uk-grid-match uk-grid uk-flex-left uk-grid-collapse"
                                uk-grid="">
                                <div>
                                        ...
                                        <div>
                                            <div class="uk-feature-font">
                                                <p class="uk-margin-remove"><strong
                                                        style="font-size: 14px !important;">Trip Grade</strong></p>
                                ...
                                <div>
                                    <div class="uk-flex uk-flex-column  uk-flex-center uk-text-center uk-margin-top">
                                        ...
                                        <div>
                                            <div class="uk-feature-font">
                                                <p class="uk-margin-remove"><strong
                                                        style="font-size: 14px !important;">Duration</strong></p>
                                ...
                                <div>
                                    <div class="uk-flex uk-flex-column  uk-flex-center uk-text-center uk-margin-top">
                                        <div class="uk-width-auto">
                                            <img src="{{ asset('theme-assets/img/icon/altitude.png') }}"
                                                class="subnav-icon" alt="">
                                        </div>
                                        <div>
                                            <div class="uk-feature-font">
                                                <p class="uk-margin-remove"><strong
                                                        style="font-size: 14px !important;">Max Elevation</strong></p>
                                ...
                                <div>
                                    <div class="uk-flex  uk-flex-column uk-flex-center uk-text-center uk-margin-top">
                                        ...
                                        <div>
                                            <div class="uk-feature-font">
                                                <p class="uk-margin-remove"><strong
                                                        style="font-size: 14px !important;">Group Size</strong></p>
                                ...
                                <div>
                                    <div class="uk-flex  uk-flex-column uk-flex-center uk-text-center uk-margin-top">
                                        ...
                                        <div>
                                            <div class="uk-feature-font">
                                                <p class="uk-margin-remove"><strong
                                                        style="font-size: 14px !important;">Transporation</strong></p>
                                ...
                                <div>
                                    <div class="uk-flex  uk-flex-column uk-flex-center uk-text-center uk-margin-top">
                                        ...
                                        <div>
                                            <div>
                                                <p class="uk-margin-remove"><strong
                                                        style="font-size: 14px !important;">Start / End</strong></p>
                                ...
                                <div>
                                    <div class="uk-flex  uk-flex-column uk-flex-center uk-text-center uk-margin-top">
                                        ...
                                        <div>
                                            <div class="uk-feature-font">
                                                <p class="uk-margin-remove"><strong
                                                        style="font-size: 14px !important;">Accommodation</strong></p>
                                ...
                                <div>
                                    <div class="uk-flex  uk-flex-column uk-flex-center uk-text-center uk-margin-top">
                                        <div class="uk-width-auto">
                                            <img src="{{ asset('theme-assets/img/icon/guided.png') }}"
                                                class="subnav-icon" alt="">
                                        </div>
                                        <div>
                                            <div class="uk-feature-font">
                                                <p class="uk-margin-remove"><strong
                                                        style="font-size: 14px !important;">Guided</strong></p>
                        ...
                        <div>
                            <div class="uk-flex">
                                <a href="#modal-customize"
                                    class="uk-extra uk-secondary-bg uk-book-btn border uk-margin-small-top "
                                    uk-toggle>Customize Your Trip</a>
                            </div>
                            @if ($schedules->count() > 0)
                                <div class="uk-flex">
                                    <a href="#offcanvas-usage"
                                        class=" uk-extra uk-primary-bg uk-book-btn border uk-margin-small-top"
                                        uk-toggle>View Dates and prices</a>
                                </div>
                        </div>
                        @endif
                    </div>
                    ...
                    @if ($experts->count() > 0)
                        <div>
                            <div class="uk-light-bg border uk-padding-small uk-margin-top">
                                <h2 class="uk-primary uk-text-uppercase uk-margin-remove" style="font-size: 24px;">Consult
                                    with Experts</h2>
                                                ...
                                                <div>
                                                    @foreach ($group as $expert)
                                                        <div class="uk-flex uk-flex-middle uk-margin-small-top">
                                                            <img src="{{ !empty($expert->thumbnail) ? asset('uploads/team/' . $expert->thumbnail) : asset('theme-assets/img/mountain/mountain1.jpeg') }}"
                                                                class="uk-sherpa-img" alt="">
                                ...
                                <div class="uk-flex">
                                    <a href="{{ route('page.posttype_detail', $teamPage->uri) }}"
                                        class="uk-extra uk-secondary-bg uk-book-btn border uk-margin-small-top ">View All
                                        Team Members</a>
                                </div>
                    ...
                    @endif
                    <div class="uk-flex">
                        <a href="{{ route('page.posttype_detail', $suggestionPage->uri) }}"
                            class="uk-extra uk-secondary-bg uk-book-btn border uk-margin-small-top ">Message from
                            director</a>
                    </div>
                    <div class="uk-light-bg uk-padding-small uk-margin-top">
                        ...
                        <div class="uk-margin-small-top">
                            <div class="uk-footer-icon uk-flex uk-flex-between">
                                <div>
                                    <a href="mailto:lhakpatrekking@gmail.com" class="uk-icon-button"
                                        style="background-color: white;"><i class="fa-solid fa-envelope"
                                            aria-hidden="true" style="color: #dd4a45;"></i></a>
                                    <a href="https://www.viber.com/" class="uk-icon-button"
                                        style="background-color: #7a509c;"><i class="fa-brands fa-viber"
                                            aria-hidden="true" style="color: white;"></i></a>
                                    <a href="https://twitter.com/" class="uk-icon-button" uk-icon="icon: x"
                    ...
                    <div class="uk-flex">
                        <a href="{{ route('page.posttype_detail', $aboutPage->uri) }}"
                            class="uk-extra uk-primary-bg uk-book-btn border uk-margin-small-top ">Lhakpa Trekking?</a>
                    </div>
                    <div class="uk-flex">
                        <a href="{{ route('page.posttype_detail', $womenPage->uri) }}"
                            class="uk-extra uk-secondary-bg uk-book-btn border uk-margin-small-top ">Women Empowerment</a>
                    </div>
                    <div class="uk-flex">
                        <a href="{{ route('page.posttype_detail', $foundationPage->uri) }}"
                            class="uk-extra uk-grey-bg uk-book-btn border uk-margin-small-top ">Mingmar Foundation</a>
                    </div>
                    <div uk-sticky="offset: 150; end: #my-id; media: @l" style="    z-index: 1;">
                        <div class="uk-light-bg border uk-padding-small uk-margin-top">
                            <h2 class="uk-primary uk-text-uppercase uk-margin-remove" style="font-size: 24px;">
                                                ...
                                                @foreach ($int_group as $int_expert)
                                                    <div class="uk-flex uk-flex-middle uk-margin-small-top uk-grid">
                                                        <div class="uk-width-1-3 uk-width-1-2@m">
                                                            <img src="{{ asset('uploads/associated/' . $int_expert->thumbnail) }}"
                                                                class="uk-sherpa-img" alt="{{ $int_expert->title }}">
                                                        </div>
                                                        <div class="uk-width-2-3 uk-width-1-2@m uk-padding-remove"
                            ...
                            <div class="uk-flex">
                                <a href="{{ route('page.posttype_detail', $internationalPage->uri) }}"
                                    class="uk-extra uk-secondary-bg uk-book-btn border uk-margin-small-top ">View All
                                    Members</a>
                            </div>
                        </div>
                        <div class="uk-flex">
                            <a href="{{ route('page.posttype_detail', $termPage->uri) }}"
                                class="uk-extra uk-primary-bg uk-book-btn border uk-margin-small-top ">Terms &
                                Condition</a>
                        </div>
                        <div class="uk-flex">
                            <a href="{{ route('page.posttype_detail', $whyusPage->uri) }}"
                                class="uk-extra uk-secondary-bg uk-book-btn border uk-margin-small-top ">Why Lhakpa
                                Trekking?</a>
                        </div>
                    </div>
                </div>
    ...
    @if ($cost_includes->isNotEmpty() || $banner->isNotEmpty() || $cost_excludes->isNotEmpty() || $guidelines->count() > 0)
        <section class="uk-position-relative custom-info-section uk-background-norepeat uk-background-cover"
            uk-parallax="bgx: -100; easing: 1;" data-src="{{ asset('theme-assets/img/bg/01.jpg') }}" id="information"
            uk-img>
            ...
            <div class="uk-container uk-position-relative">
                ...
                <ul class="uk-subnav uk-subnav-pill uk-why-us-tab uk-flex-center"
                            ...
                            <ul uk-accordion class="uk-information-ul">
                                @foreach ($cost_includes as $item)
                                    <li class="uk-information-li">
                                        <a class="uk-accordion-title uk-accordion-font" href><span
                                                class="uk-margin-small-right">{{ $loop->iteration }}</span>{{ $item->title }}</a>
    ...
    <section class="uk-section uk-section-overlap-top-light" id="faq">
        <div class="uk-container">
            @if ($faqs->count() > 0)
                <div class="uk-font uk-text-center">
                    <span class="uk-primary uk-text-uppercase f-27 "><i
                            class="fa-solid fa-person-circle-question uk-margin-small-right"
                            aria-hidden="true"></i>FAQs</span>
                </div>
                <ul class="uk-detail-list uk-light-bg uk-padding uk-responsive-padding border" uk-accordion>
                    @foreach ($faqs as $item)
                        <li class="{{ $loop->first ? 'uk-open' : '' }}">
                            <a class="uk-accordion-title" style="font-size:16px ; font-weight:600;" href><span
                                    class="uk-margin-right">{{ $loop->iteration }}</span>{{ $item->title }}</a>
                            <div class="uk-accordion-content uk-margin-remove">
    ...
    <section class="uk-section-small" id="review">
        ...
        <div class="uk-container uk-container-small">
            <div class="uk-text-right uk-margin-small-top">
                <a href="{{route('feedback_all')}}"
                class="view-all-reviews text-primary read-more-btn"
                style="font-size:0.78rem; letter-spacing:0.15em; text-transform:uppercase; font-weight:600; text-decoration:none;">
                    View All &rarr;
                </a>
            </div>
        </div>
                            ...
                            <div class=" uk-flex-middle uk-grid-match uk-grid-collapse" uk-height-match uk-grid>
                                <div class="uk-width-2-5@s">
                                    <a href="{{ url('page/' . tripurl($row->uri)) }}"
                                        class="uk-display-block uk-inline-clip uk-transition-toggle uk-link-toggle">
                                        <img src="{{ !empty($row->thumbnail) ? asset('uploads/original/' . $row->thumbnail) : asset('theme-assets/img/mountain/mountain3.jpeg') }}"
                                            class="uk-height-1-1 uk-width-1-1 uk-transition-scale-up uk-transition-opaque uk-trip-image"
                                            alt="">
                                    </a>
                                </div>
                                    ...
                                    <div class="uk-flex uk-flex-between uk-margin-small-top uk-margin-small-bottom">
                                        <div class="uk-flex uk-flex-middle uk-trip">
                                            ...
                                            <div>
                                                ...
                                                <p class="uk-trip-description uk-margin-remove">{{ $row->duration }} Days
                                                </p>
                                            </div>
                                        </div>
                                        <div class="uk-flex uk-flex-middle uk-trip ">
                                            ...
                                            <div>
                                                ...
                                                <p class="uk-trip-description uk-margin-remove">
                                                    {{ getDestinationNameByTripId($row->id) }}</p>
                                            </div>
                                        </div>
                                        <div class="uk-flex uk-flex-middle uk-trip ">
                                            <i class="fa-solid fa-calendar"></i>
                                            <div>
                                                ...
                                                <p class="uk-trip-description uk-margin-remove">{{ $row->trip_grade }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="uk-margin-remove two-line" style="line-height: 20px; font-size: 15px;">
                                        {{ $row->sub_title }}</p>
                                </div>
                            </div>
                        </div>
    ...
    <div id="offcanvas-review" uk-modal>
        <div
            class="uk-modal-dialog uk-modal-body uk-padding-remove-top uk-padding-remove-left uk-padding-remove-right uk-padding-bottom">
            <div class="uk-padding uk-padding-remove-bottom">
                <h3 class="uk-modal-title uk-text-center uk-white uk-margin-remove uk-primary-bg border">write a review
                </h3>
                <button class="uk-modal-close-default" type="button" uk-close></button>
                <form class="uk-contact-form" action="{{ route('review.create') }}" method="post"
                    ...
                    <div class=" uk-child-width-1-2@m uk-grid">
                        <div class="uk-margin-small-top">
                            ...
                            <div class="uk-form-controls">
                                <input class="uk-input" id="fullname" name="full_name"
                                    value="{{ Auth::check() ? Auth::user()->name : '' }}" required type="text">
                            </div>
                        </div>
                        <div class="uk-margin-small-top">
                            ...
                            <div class="uk-form-controls">
                                <input class="uk-input" id="email" name="email"
                                    value="{{ Auth::check() ? Auth::user()->email : '' }}" required type="email">
                            </div>
                        </div>
                        <div class="uk-margin-small-top">
                            <label class="uk-form-label uk-text-bold" for="image">Image</label>
                            <div class="uk-form-controls">
                                <input class="uk-input" id="image" name="image" type="file"
                                    style="padding: 6px;">
                            </div>
                        </div>
                        <div class="uk-margin-small-top">
                    ...
                    <ul class="uk-margin-remove uk-padding-remove" style="list-style: none;">
                        @foreach ($schedules as $item)
                            <li class="uk-price-li">
                                <div class="uk-grid-small uk-child-width-expand@m uk-child-width-1-1 uk-flex-middle uk-border-bottom"
                                    uk-grid>
                                    <div class="uk-black uk-text-bold uk-secondary">
                                        <span class="uk-block uk-hidden@m">Dates:
                                        </span>{{ date('d M, Y', strtotime($item->start_date)) }} – <br
                                            class="uk-visible@s"> {{ date('d M, Y', strtotime($item->end_date)) }}
                                    </div>
                                    <div class="uk-black uk-flex">
                                        ...
                                        <div class="custom-flex">
                                            @if ($item->old_price1)
                                                <span
                                                    style="color: #b50000; text-decoration: line-through; margin-right:5px;">US
                                                    ${{ $item->old_price1 }}</span>
                                            @endif
                                            @if ($item->price)
                                    ...
                                    @if ($item->availability != 'CLOSED')
                                        <form action="{{ route('page.booking', $data->uri) }}" method="post"
                                            ...
                                            <input type="hidden" name="schedule_id"
                                                id="schedule_id{{ $item->id }}" value="{{ $item->id }}">
                                            <button type="button"
                                                onclick="document.getElementById('form-{{ $item->id }}').submit();"
                                                class="uk-btn uk-btn-secondary">Book Now</button>
                                        </form>
                                    @endif
                                </div>
            ...
            <form class="uk-contact-form uk-margin-top" action="{{ route('inquiry') }}" method="POST">
                ...
                @if ($data->latest_info)
                    ...
                    <div class="uk-flex uk-flex-middle uk-margin-top">
                        ...
                        <button class="uk-button uk-button-default uk-info-button" type="button"
                            uk-toggle="target: .toggle">View Info</button>
                    </div>
                    <p class="toggle"></p>
                ...
                <div class="uk-margin-top uk-text-center">
                    ...
                    <button type="submit" class="uk-btn uk-btn-secondary">Submit Now <span
