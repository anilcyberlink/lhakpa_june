...
<a href="<?php echo e(url('admin/trip')); ?>" class="btn btn-default btn-sm backlink"><i class="fa fa-list" aria-hidden="true"></i> Show List </a>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">          
                         ...
                         <div class="tab-pane" id="tab_2">
                            <?php echo $__env->make('admin.trips.edit.edit-itinerary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <div class="tab-pane" id="tab_3">
                             <?php echo $__env->make('admin.trips.edit.edit-cost-includes', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <div class="tab-pane" id="tab_4">
                            <?php echo $__env->make('admin.trips.edit.edit-cost-excludes', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_6">
                            <?php echo $__env->make('admin.trips.edit.edit-banner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_9">
                           <?php echo $__env->make('admin.trips.edit.edit-guide', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
                        </div>
                    </div>
                    <!-- /.tab-content -->
                </div><!-- /.card-body -->
...
<?php $__env->startSection('scripts'); ?>
       ...
       jQuery(document).delegate('a.add-banner', 'click', function(e) {
        ...
        jQuery(document).delegate('button.delete-banner', 'click', function(e) {
            ...
            if (makeConfirm == true) {
                ...
                var trip_id = '<?php echo e($data->id); ?>';
                var url =
                    '<?php echo e(route('trip_banner_destory', ['id' => ':id', 'banner_id' => ':banner_id'])); ?>';
                url = url.replace(':id', trip_id);
        ...
        jQuery(document).delegate('.delete_banner_thumb', 'click', function(e) {
            ...
            var url = '<?php echo e(route('delete_banner_thumb', ['id' => ':id'])); ?>';
       ...
       /*End of Banner*/
        ...
        jQuery(document).delegate('button.delete-guide', 'click', function(e) {
            ...
            if (makeConfirm == true) {
                ...
                var trip_id = '<?php echo e($data->id); ?>';
                var url = '<?php echo e(route('supporting-guide.destroy', ['id' => ':id', 'guide_id' => ':guide_id'])); ?>';
                url = url.replace(':id', trip_id);
  ...
  /******/
   $('.bannerdelete').on('click',function(e){
    ...
    $.ajax({
      type:'delete',
      url:"<?php echo e(url('delete_trip_banner') . '/'); ?>" + id,
      data:{_token:csrf},
      success:function(data){
  ...
  //mapdelete
    ...
    $.ajax({
      type:'delete',
      url:"<?php echo e(url('delete_map') . '/'); ?>" + id,
      data:{_token:csrf},
      success:function(data){
  ...
  $('.chartdelete').on('click',function(e){
    ...
    $.ajax({
      type:'delete',
      url:"<?php echo e(url('delete_chart') . '/'); ?>" + id,
      data:{_token:csrf},
      success:function(data){
  ...
  $('.pdfdelete').on('click',function(e){
    ...
    $.ajax({
      type:'delete',
      url:"<?php echo e(url('delete_pdf') . '/'); ?>" + id,
      data:{_token:csrf},
      success:function(data){
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lhakpa/public_html/resources/views/admin/trips/edit.blade.php ENDPATH**/ ?>