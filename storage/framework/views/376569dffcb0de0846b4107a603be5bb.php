...
<a href="<?php echo e(route('admin.post.index', Request::segment(3))); ?>" class="btn btn-primary btn-sm">Go Back</a>
<?php endif; ?>
<a href="<?php echo e(url('admin/associated/'.Request::segment(3).'/'.Request::segment(4).'/create')); ?>" class="btn btn-primary btn-sm">Create</a>
          ...
          <tbody>
            ...
            <tr class="id<?php echo e($row->id); ?>">
              ...
              <td class="post_title title_hi_sh"> 
                ...
                <div class="row_actions"><span class="id">ID: <?php echo e($row->id); ?> | </span><span class="edit"><a href="<?php echo e(url( 'admin/associated/'.Request::segment(3) .'/'. $row->id. '/edit')); ?>" aria-label="">Edit</a> 
                 </span>   |             
                ...
                <?php if($row->thumbnail): ?>            
                  <img src="<?php echo e(asset(env('PUBLIC_PATH').'uploads/associated/' . $row->thumbnail)); ?>" width="100" />
                  <?php endif; ?>          
                </td>
...
(function ( $ ) { 
  $('.submitdelete1').on('click',function(e){
    ...
    $.ajax({
      type:'delete',
      url:"<?php echo e(url('admin/associated/').'/'.Request::segment(3).'/'); ?>" + id,
      data:{_token:csrf},    
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lhakpa/public_html/resources/views/admin/associated-post/index.blade.php ENDPATH**/ ?>