...
<?php $__env->startSection('content'); ?>
        ...
        <div>
            <div class="uk-grid-collapse uk-grid" uk-height-match="target: .uk-same-height">
                <div class="uk-width-1-3@m">
                    <img src="<?php echo e($your_group_post->page_thumbnail ? asset('uploads/medium/'.$your_group_post->page_thumbnail ) : asset('theme-assets/img/mountain/mountain8.jpeg')); ?>" class="cover uk-same-height" alt="<?php echo e($data->post_type); ?>">
                </div>
                <div class="uk-width-2-3@m uk-same-height">
                    <div class="uk-title-font  uk-container uk-section uk-padding-large">
                        <h1 class="uk-secondary"><?php echo e($your_group_post->post_title); ?></h1>
                        <span class="dotted-line-primary"></span>
                        <p><?php echo $your_group_post->post_content; ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="uk-section">
        <div class="uk-container">
            <h2 class="uk-primary uk-margin-remove"><?php echo e($data->associated_title); ?></h3>
            <span class="dotted-line-black"></span>
            <p><?php echo e($data->content); ?></p>
            <div class=" border border uk-box-shadow-large">
                <form action="<?php echo e(route('customize-trip.post')); ?>" method="POST" class="uk-padding">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="uk-margin-small-top">
                            ...
                            <div class="uk-form-controls">
                                <select class="uk-select" aria-label="Select" name="travel_type" id="travel_type" required>
                                    ...
                                    <?php $__currentLoopData = $travels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($trip->id); ?>"><?php echo e($trip->title); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lhakpa/public_html/resources/views/themes/default/posttypeTemplate-group.blade.php ENDPATH**/ ?>