              ...
              <tr class="id<?php echo e($row->id); ?>">
                ...
                <td class="post_title title_hi_sh" >
                  ...
                  <div class="row_actions">
                    ...
                    <span class="edit"><a
                      href="<?php echo e(url('admin/trip/'  . $row->id . '/edit')); ?>"
                      aria-label="">Edit</a>
                    </span>
                  ...
                  <td class="">
				    <form action="<?php echo e(route('trip_of_the_month',$row->id)); ?>" method="POST">
						<?php echo csrf_field(); ?>	
						 <?php if(($row->trip_of_the_month)==0): ?>
                      <button class="btn btn-danger btn btn-sm" name="trip_of_the_month" value="0" type="submit"><i
                              class="fa fa-times"></i>
                      </button>
                 		 <?php else: ?>
                      <button class="btn btn-success btn btn-sm" name="trip_of_the_month" value="1" type="submit"><i
                              class="fa fa-check"></i>
                      </button>
               	   <?php endif; ?>								 									
                  ...
                  <td >
                    ...
                    <?php $__currentLoopData = $row->activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <span><?php echo e($value->title); ?></span><br>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                  </td>

                  <td>
                      <?php echo e(($row->video_status == 1)?'Famous':''); ?>

                    <?php if($row->tripgroups): ?>
                    <?php $__currentLoopData = $row->tripgroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <span><?php echo e($_row->title); ?></span><br>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                  </td>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lhakpa/public_html/resources/views/admin/trips/index.blade.php ENDPATH**/ ?>