        ...
        <div class="col-md-12">
            ...
            <div class="panel">
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                 <textarea class="form-control" id="contentEditor5" name="meta_key"
                                          rows="3"><?php echo e($data->meta_key); ?></textarea>
                                          </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component"> <textarea class="form-control" id="contentEditor5" name="meta_description"
                                          rows="3"><?php echo e($data->meta_description); ?></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="bs-component">
                    <textarea name="flight_brief" id="" class="form-control"><?php echo e($data->flight_brief); ?></textarea>
                    </div>
                </div>
            </div>
                </div>
        ...
        <?php /**PATH /home/lhakpa/public_html/resources/views/admin/settings/contact.blade.php ENDPATH**/ ?>