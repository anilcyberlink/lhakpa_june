...
<a href="<?php echo e(route('subscriber.create')); ?>" class="btn btn-primary btn-sm">Add Emails</a>
<a href="<?php echo e(route('download')); ?>" class="btn btn-primary btn-sm">Download CSV</a>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('admin.viewDetail',$value->id)); ?>">View Details </a>
                                        <!--<a href="<?php echo e(route('subscriber.update',$value->id)); ?>">Edit </a> |-->
                                        <!-- <a href="<?php echo e(route('user.delete',$value->id)); ?>">Delete</a>-->
                                    </td>
                                </tr>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lhakpa/public_html/resources/views/admin/newsletter/user-index.blade.php ENDPATH**/ ?>