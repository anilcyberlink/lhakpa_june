                        ...
                        <table class="table admin-form table-striped dataTable" id="datatable3">
                            ...
                            <tbody>
                                <?php if(count($agents) > 0): ?>
                                    <?php $__currentLoopData = $agents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="bg-light">
                                            <td class=""><?php echo e($key+=1); ?></td>
                                            <td class=""><?php echo e(ucfirst($row->name)); ?> <br> <?php echo e(($row->email)); ?> <br> <?php echo e($row->phone); ?> <br> <?php echo e($row->designation); ?></td> 
                                            <td class=""><?php echo e($row->country); ?>  <br> <?php echo e($row->pcode); ?> </td>
                                            <td class=""><?php echo e($row->cname); ?> <br> <?php echo e($row->url); ?></td>
                                            <td class=""><?php echo e($row->created_at->format('d M Y')); ?></td>
                                            <td class=""><textarea><?php echo $row->message; ?></textarea></td>
                                        
                                            <td class="">
                                                <form action="<?php echo e(route('need-agent.destroy', $row->id)); ?>" method="POST">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lhakpa/public_html/resources/views/admin/need-agent/index.blade.php ENDPATH**/ ?>