...
<?php if(Request::segment(2) != 'terms-conditons'): ?>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                        <div class="bs-component">
                          <textarea class="form-control" id="textArea3" name="post_excerpt" rows="3"> <?php echo e($data->post_excerpt); ?></textarea>
                        </div>
                      </div>
                    </div>
<?php endif; ?>
                    <div class="form-group">
                      ...
                      <div class="col-lg-10">
                        <div class="bs-component">
                          <textarea class="form-control my-editor" id="editor2" name="post_content" rows="12"> <?php echo e($data->post_content); ?></textarea>
                        </div>
                      </div>
                    </div>
              ...
              <div class="col-md-3">
               ...
               <!--   <div class="hd_show_con">-->
               <!--     <div id="xedit-demo">-->
               <!--      <input type="text" name="page_video" class="form-control" value="<?php echo e($data->page_video); ?>" />-->
               <!--    </div>-->
               <!--  </div>-->
               <!--</div>-->
...
$('.bannerdelete').on('click',function(e){
  ...
  $.ajax({
    type:'delete',
    url:"<?php echo e(url('delete_post_banner') . '/'); ?>" + id,
    data:{_token:csrf},    
    success:function(data){ 
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lhakpa/public_html/resources/views/admin/posts/edit.blade.php ENDPATH**/ ?>