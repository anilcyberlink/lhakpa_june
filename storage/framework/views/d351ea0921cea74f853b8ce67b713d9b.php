      ...
      <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <?php if($banner->youtube_link): ?>
            <div class="swiper-slide">
               <div class="uk-position-relative" id="ytbg3" data-ytbg-fade-in="true" data-ytbg-mute-button="true" data-youtube="https://youtu.be/<?php echo e($banner->youtube_link); ?>"></div>
         ...
         <?php else: ?>
            ...
            <div class="swiper-slide">
               <div class="uk-inline hero-items">
                  <img src="<?php echo e($banner->picture ? asset('uploads/banners/'.$banner->picture) : asset('theme-assets/img/mountain/mountain5.jpeg')); ?>" width="1800" height="1200" alt="">
         ...
         <div class="uk-grid-match uk-flex uk-flex-middle" uk-grid>
               <div class="uk-width-1-3@m">
                  <div class="uk-title-font">
                     ...
                     <a href="<?php echo e(route('page.activitylist')); ?>" class="uk-btn uk-btn-secondary">Discover All Activities</a>
                  </div>
               </div>
                        ...
                        <?php $__currentLoopData = $activity_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <div class="uk-media-400 uk-activities">
                              <?php if($row->external_link): ?>
                                 <a href="<?php echo e($row->external_link); ?>" class="uk-list-shine uk-display-block uk-inline-clip uk-transition-toggle uk-link-toggle uk-height-1-1">
                              <?php else: ?>
                                 <a href="<?php echo e(route('activity-list', $row->uri)); ?>" class="uk-list-shine uk-display-block uk-inline-clip uk-transition-toggle uk-link-toggle uk-height-1-1">
                              <?php endif; ?>
                                 <img src="<?php echo e($row->thumbnail ? asset('uploads/icon/'.$row->thumbnail) : asset('theme-assets/img/mountain/mountain1.jpeg')); ?> " class="uk-height-1-1 uk-transition-scale-up uk-transition-opaque" width="1800" height="1200" alt="<?php echo e($row->title); ?>">
              ...
              <div class="uk-container uk-flex uk-flex-middle uk-margin-top uk-margin-bottom">
                  <div class="uk-title-font uk-contents">
                    ...
                    <!-- <span class="uk-white uk-contents">  -->
                     ...
                     <!-- </span> -->
                    <a href="<?php echo e(route('page.posttype_detail',$about_us->uri)); ?>" class="uk-about-btn">Learn More <i class="fa-solid fa-circle-arrow-right uk-margin-small-left"></i></a>
                </div>
            </div> 
        </div>
        <div class="uk-width-1-4@m uk-padding uk-flex uk-flex-center uk-flex-middle ">
            <img src="<?php echo e(asset('theme-assets/img/logo.gif')); ?>" class="about-img" alt="<?php echo e($about_us->post_type); ?>">
         </div>
      </div>
   </section>
<?php endif; ?>
               ...
               <div>
                  <div class=" uk-flex-middle uk-grid-match uk-grid-collapse" uk-height-match uk-grid>
                     <div class="uk-width-2-5@s">
                           <a href="<?php echo e(url('page/' . tripurl($row->uri))); ?>" class="uk-list-shine uk-display-block uk-inline-clip uk-transition-toggle uk-link-toggle ">
                              <img src="<?php echo e(!empty($row->thumbnail) ? asset('uploads/original/'.$row->thumbnail) : asset('theme-assets/img/mountain/mountain3.jpeg')); ?>" class="uk-trip-image uk-transition-scale-up uk-transition-opaque" alt="<?php echo e($row->trip_title); ?>">
                           </a>
                     </div>
                           ...
                           <div class="uk-flex uk-flex-between uk-margin-small-top uk-margin-small-bottom">
                              ...
                              <div class="uk-flex uk-flex-middle uk-trip ">
                                 ...
                                 <div>
                                       ...
                                       <p class="uk-trip-description uk-margin-remove"><?php echo e(optional($row->destinations()->first())->title); ?></p>
                                 </div>
                              </div>
                              <div class="uk-flex uk-flex-middle uk-trip ">
                                 <i class="fa-solid fa-calendar"></i>
   ...
   <section class="uk-position-relative uk-section  uk-background-norepeat 
      uk-background-cover" uk-parallax="bgx: -100; easing: 1;" data-src="<?php echo e(asset('theme-assets/img/bg/01.jpg')); ?>" uk-img style="padding-bottom: 105px;">
               ...
               <div class="uk-position-relative uk-visible-toggle uk-margin-medium-top" tabindex="-1" uk-slider=" sets: true; autoplay: true;  autoplay-interval: 3000;">
                  <ul class="uk-slider-items uk-child-width-1-1">
                      <!--<li>-->
                        ...
                        <!--         <div>-->
                        <!--            <a href="<?php echo e(url('page/' . tripurl($row->uri))); ?>" class="uk-display-block uk-inline-clip uk-transition-toggle uk-link-toggle uk-media-400 uk-res-height">-->
                        <!--                  <img src="<?php echo e(!empty($row->thumbnail) ? asset('uploads/original/'.$row->thumbnail) : asset('theme-assets/img/mountain/mountain5.jpeg')); ?>" class="uk-height-1-1 uk-transition-scale-up uk-transition-opaque" alt="<?php echo e($row->trip_title); ?>">-->
                        <!--            </a>-->
                        <!--         </div>-->
                        ...
                        <!--                        <p class="uk-small-description uk-margin-remove uk-white"><?php echo e($row->duration); ?> Days</p>-->
                        <!--                     </div>-->
                        <!--                  </div>-->
                        <!--                  <div class="uk-flex uk-flex-middle">-->
                        ...
                        <!--                        <p class="uk-small-description uk-margin-remove uk-white"><?php echo e(($row->trip_grade)); ?></p>-->
                        <!--                     </div>-->
                        <!--                  </div>-->
                        <!--            </div>-->
                        <!--            <p class="uk-white line-three uk-margin-remove-top"><?php echo e($row->sub_title); ?></p>-->
                        <!--            <div>-->
                        <!--                  <a href="<?php echo e(url('page/' . tripurl($row->uri))); ?>" class="uk-about-btn">Learn More <i class="fa-solid fa-circle-arrow-right uk-margin-small-left"></i></a>-->
                        <!--            </div>-->
                        <!--         </div>-->
                        <!--      </div>-->
                        <!--</li>-->
                     <?php $__currentLoopData = $lastMomentTrip; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(url('page/' . tripurl($row->uri))); ?>">
                                ...
                                <img src="<?php echo e(!empty($row->banner) ? asset('uploads/banners/'.$row->banner) : asset('theme-assets/img/mountain/mountain5.jpeg')); ?>" class="uk-height-1-1 uk-transition-scale-up uk-transition-opaque" alt="<?php echo e($row->trip_title); ?>">
                                <div class="uk-overlay uk-overlay-default uk-position-bottom uk-adv-overlay">
                                   <div>
                                    ...
                                    <div class="uk-flex uk-flex-middle uk-title-font uk-grid-collapse" uk-grid>
                                        ...
                                        <div class="uk-width-1-4@m uk-text-left uk-text-right@m">
                                             <a href="<?php echo e(url('page/' . tripurl($row->uri))); ?>" class="uk-about-btn">Learn More <i class="fa-solid fa-circle-arrow-right uk-margin-small-top"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
         ...
         <div class="uk-slider-items uk-child-width-1-1  uk-child-width-1-2@m uk-child-width-1-3@l uk-grid">
            <?php $__currentLoopData = $trekking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trek): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <div class="uk-media-500 uk-activities" style="overflow:hidden;">
                  <a href="<?php echo e(route('trekking-list',$trek->uri)); ?>" class="uk-list-shine uk-inline uk-transition-toggle uk-link-toggle uk-height-1-1 uk-width-1-1" style="overflow: hidden;">
                     <img src="<?php echo e(!empty($trek->thumbnail) ? asset('uploads/icon/'.$trek->thumbnail) : asset('theme-assets/img/mountain/mountain3.jpeg')); ?>" class="uk-height-1-1 uk-transition-scale-up uk-transition-opaque" width="1800" height="1200" alt="">
                     <div class="uk-overlay-primary  uk-banner-overlay uk-position-cover"></div>
                     ...
                     <div class="uk-overlay uk-position-center uk-light uk-text-center uk-title-font ml-20">
                        ...
                        <!--</div>-->
                        <div>
                           <a href="<?php echo e(route('trekking-list',$trek->uri)); ?>" class="uk-about-btn">Learn More <i class="fa-solid fa-circle-arrow-right uk-margin-small-left"></i></a>
                        </div>
                     </div>
        ...
        <div class="uk-position-relative uk-visible-toggle uk-light uk-margin-top" tabindex="-1" uk-slider="sets: true">
             <div class="uk-slider-items uk-child-width-1-1  uk-child-width-1-2@m uk-child-width-1-3@l uk-grid">
                <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <div>
                      <a href="<?php echo e(route('page.pagedetail', $row->uri)); ?>" class="uk-list-shine uk-display-block uk-inline-clip uk-transition-toggle uk-link-toggle uk-media-280">
                         <img src="<?php echo e(!empty($row->page_thumbnail) ? asset('uploads/original/'.$row->page_thumbnail) : asset('theme-assets/img/mountain/mountain5.jpeg')); ?> " class="uk-height-1-1 uk-transition-scale-up uk-transition-opaque" alt="">
                      </a>
   ...
   <section class="uk-primary-bg">
      <div class="uk-child-width-1-2@m uk-grid-match uk-grid-collapse" uk-grid>
         <div>
               <img src="<?php echo e(asset('theme-assets/img/review.jpeg')); ?>" alt="" style="height:100%; object-fit:cover;">
         </div>
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lhakpa/public_html/resources/views/themes/default/frontpage.blade.php ENDPATH**/ ?>