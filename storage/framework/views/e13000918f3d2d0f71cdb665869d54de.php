        ...
        <div class="uk-container uk-flex uk-flex-center">
            <div class="uk-card uk-card-default uk-padding uk-margin-auto-vertical border" style="padding-bottom:60px; width: 678px; max-width: 100% !important;">
                ...
                <div class="uk-switcher uk-margin">
                    <div>
                        <form class="uk-contact-form" action="<?php echo e(route('reset.password')); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lhakpa/public_html/resources/views/themes/default/forgot-password.blade.php ENDPATH**/ ?>