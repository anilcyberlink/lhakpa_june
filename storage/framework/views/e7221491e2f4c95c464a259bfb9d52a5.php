...
<div class="col-md-12">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            ...
                            value="<?php echo e($data->usa_address); ?>"/>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                <input type="text" id="inputStandard" name="usa_phone" class="form-control" placeholder=""
                                       value="<?php echo e($data->usa_phone); ?>"/>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                <input type="text" id="inputStandard" name="usa_email_primary" class="form-control"
                                       placeholder="" value="<?php echo e($data->usa_email_primary); ?>"/>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                <input type="text" id="inputStandard" name="usa_email_secondary" class="form-control"
                                       placeholder="" value="<?php echo e($data->usa_email_secondary); ?>"/>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <?php /**PATH /home/lhakpa/public_html/resources/views/admin/settings/usaDetails.blade.php ENDPATH**/ ?>