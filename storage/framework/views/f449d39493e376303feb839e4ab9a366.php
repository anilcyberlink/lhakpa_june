<div class="row">
    <div class="col-md-8">
                    ...
                    <div class="col-lg-12">
                        <div class="bs-component">
                            <input type="text" id="sub_title" name="sub_title" class="form-control"
                                placeholder="Sub Title" value="<?php echo e(old('sub_title')); ?>" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-12">
                        <div class="bs-component">
                            ...
                            <textarea class="my-editor form-control" value="<?php echo e(old('status_text')); ?>" name="status_text"></textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="bs-component">
                            <label>Max Elevation</label>
                            <input type="text" name="max_altitude" class="form-control" value="<?php echo e(old('max_altitude')); ?>" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="bs-component">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <div class="bs-component">
                            ...
                            <input type="text" name="best_season" class="form-control" value="<?php echo e(old('best_season')); ?>" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-lg-6">
                        <div class="bs-component">
                            <label>Price ($)</label>
                            <input type="number" min="1" name="price" class="form-control" value="<?php echo e(old('price')); ?>" placeholder="IN USD" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="bs-component">
                            <label>Price (€) </label>
                            <input type="number" min="1" name="price_euro" class="form-control" value="<?php echo e(old('price_euro')); ?>" placeholder="IN EURO"/>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="bs-component">
                    ...
                    <div class="col-lg-6">
                        <div class="bs-component">
                            ...
                            <input type="number" min="1" name="duration" class="form-control" value="<?php echo e(old('duration')); ?>" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-lg-6">
                        <div class="bs-component">
                            ...
                            <input type="text" name="accommodation" class="form-control" value="<?php echo e(old('accommodation')); ?>" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="bs-component">
                            <label>Daily Activity</label>
                            <input type="text" name="walking_per_day" class="form-control" value="<?php echo e(old('walking_per_day')); ?>" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="bs-component">
                ...
                <!--                value="<?php echo e(old('start-date')); ?>" />-->
                <!--        </div>-->
                <!--    </div>-->
                <!--</div>-->
                 <div class="form-group">
                    ...
                    <!--       <input type="text" class="form-control" name="trip_video" value="<?php echo e(old('trip_video')); ?>" placeholder="Video ID" />-->
                    <!--    </div>-->
                    <!--</div>  -->
    ...
    <div class="panel">
        ...
        placeholder="Trip Highlights"><?php echo e(old('trip_highlight')); ?></textarea>
        </div>
        </div>
        </div>
        </div>
        ...
        <div class="col-lg-12">
         <div class="bs-component">
         <textarea class="my-editor form-control" name="trip_excerpt" rows="3"><?php echo e(old('trip_excerpt')); ?></textarea>
        </div>
        </div>
        </div>
          </div>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="col-lg-12">
                        <div class="bs-component">
                            <textarea class="form-control my-editor" name="trip_content" rows="9"><?php echo e(old('trip_content')); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="col-lg-12">
                        <div class="bs-component">
                            <textarea class="form-control my-editor" name="latest_info" rows="9"><?php echo e(old('latest_info')); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <?php if($destinations->count() > 0): ?>
                                <ul class="ctgor">
                                    <?php $__currentLoopData = $destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <label class="option">
                                                <input type="radio" name="destination[]" value="<?php echo e($row->id); ?>" <?php if(is_array(old('destination')) && in_array($row->id, old('destination'))): ?> checked <?php endif; ?> />
                        ...
                        <?php $__currentLoopData = $trip_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($row->trip_type == 'Trekking' || $row->trip_type == 'Expedition'): ?>
                                <?php if($row->trip_type == 'Trekking'): ?>
                                    <option value="<?php echo e($row->id); ?>">Destination</option>
                                <?php else: ?>
                    ...
                    <?php if( $activity->count() > 0): ?>
                        <ul class="">
                            <?php $__currentLoopData = $activity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <label class="option">
                                        <input type="checkbox" name="activity_type[]" value="<?php echo e($row->id); ?>" class="single-check">
                                        <span class="checkbox"></span> <?php echo e($row->title); ?>
...
<?php /**PATH /home/lhakpa/public_html/resources/views/admin/trips/create/create-general.blade.php ENDPATH**/ ?>