                            ...
                            <tbody>
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="id<?php echo e($row->id); ?>">
                                        ...
                                        <td><?php echo e($row->trip); ?></td>
                                        <td><?php echo e($row->full_name); ?></td>
                                        <td>
                                            <a href="<?php echo e(route('admin.feedbacks.show',$row->id)); ?>">View</a>
                                            |
                                            <form action="<?php echo e(route('admin.feedback.destroy', $row->id)); ?>" method="POST" style="display:inline-block;" onsubmit="return confirm('Confirm Delete?')">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lhakpa/public_html/resources/views/admin/feedback/index.blade.php ENDPATH**/ ?>